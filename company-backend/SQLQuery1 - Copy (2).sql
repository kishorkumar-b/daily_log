...
CREATE TABLE Employees (
    emp_id INT IDENTITY(1,1) PRIMARY KEY,      -- manually provide emp_id
...
CREATE TABLE Users (
    ...
    status VARCHAR(20) DEFAULT 'InProgress'    -- Active/Inactive
);
INSERT INTO Users (username, password, role, full_name, team, designation, date_of_joining, salary, status)
VALUES ('admin', 'admin123', 'Admin', 'Administrator', 'Management', 'Admin', '2025-11-11', 100000.00, 'Active');
...
('SDMS', '2025-01', 5, 50000.00, 90000.00),
('LIMS', '2025-02', 7, 72000.00, 70285.71),
...
INSERT INTO Products (product_id, product_name, budget, total_employees, team, status, created_date)
VALUES
(101, 'Product101', 50000, 12, 'SDMS', 'Active', '2025-01-01'),
(102, 'Product102', 65000, 8, 'LIMS', 'Active', '2025-02-01'),
(103, 'Product103', 42000, 10, 'LIMS', 'Inactive', '2025-03-01'),
(104, 'Product104', 80000, 15, 'SDMS', 'Active', '2025-04-01'),
(105, 'Product105', 50000, 12, 'LIMS', 'Active', '2025-05-01'),
(106, 'Product106', 65000, 8, 'SDMS', 'Active', '2025-06-01');
